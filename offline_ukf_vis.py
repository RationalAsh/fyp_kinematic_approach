...
from scipy.signal import specgram
...
plt.figure()
plt.plot(yprvals[:,0], label='yaw')
plt.plot(yprvals[:,1], label='pitch')
plt.plot(yprvals[:,2], label='roll')
plt.xlabel('Sample')
plt.ylabel('Angle')
plt.legend()
plt.title('Filtered orientation values')
plt.show()
